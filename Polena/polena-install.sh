...
wget http://xenomai.org/downloads/ipipe/v4.x/x86/ipipe-core-${linux_ver}-x86-4.patch

echo
echo "## Patching Linux Kernel"
cd linux-${linux_ver}
./../xenomai-3/scripts/prepare-kernel.sh --arch=${arch} --ipipe=../ipipe-core-${linux_ver}-x86-4.patch
echo "I-Pipe patched"
